...
aliases: 
  - ../beginners/basic-ml/tutorial_overfit_underfit.qmd
---
...
In both of the previous examples — [classifying text](text_classification_with_hub.qmd) and [predicting fuel efficiency](regression.qmd) — the accuracy of models on the validation data would peak after training for a number of epochs and then stagnate or start decreasing.
...
<iframe src="https://tensorboard.dev/experiment/vW7jmmF9TmKmy3rbheMQpw/#scalars&_smoothingWeight = 0.97"  width="100%" height = "800px"></iframe>
...
These models also recorded TensorBoard logs. Use the following to visualize the
tensorboard:
