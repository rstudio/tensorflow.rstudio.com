...
aliases: 
  - ../beginners/basic-ml/tutorial_basic_text_classification.qmd
---
...
Next, you will use the `text_dataset_from_directory` utility to create a labeled TensorFlow Dataset. [tfdatasets](https://www.tensorflow.org/guide/data) is a powerful collection of tools for working with data. 
...
Note: To prevent [training-testing skew](https://developers.google.com/machine-learning/guides/rules-of-ml#training-serving_skew) (also known as training-serving skew), it is important to preprocess the data identically at train and test time. To facilitate this, the `text_vectorization` layer can be included directly inside your model, as shown later in this tutorial.
...
You can use `as.data.frame(history)` to obtain a data.frame with metrics per epoch or
`plot(history)` as below:
