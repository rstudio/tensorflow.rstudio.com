...
In addition to [sequential models](../sequential_model/) and models created with the [functional API](../functional_api/), you may also define models by defining a custom `call()` (forward pass) operation. 
