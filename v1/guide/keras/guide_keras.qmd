...
parameters:
  ...
  - `activation`: Set the [activation function](https://tensorflow.rstudio.com/reference/keras/#section-activations) for the layer. By default, no activation is applied.
