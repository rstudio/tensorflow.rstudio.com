...
Note that tensor operations are executed using the Keras `backend()`. See the [Keras Backend](../backend/) article for details on the various functions available from Keras backends.
