...
execute:
  eval: false
aliases:
  - ../guide/keras/examples/conv_lstm/index.html
---

This script demonstrates the use of a convolutional LSTM network. This
network is used to predict the next frame of an artificially generated
movie which contains moving squares.
...
-   The squares are of shape 1x1 or 2x2 pixels, which move linearly over
    time.
-   For convenience we first create movies with bigger width and height
    (80x80)
