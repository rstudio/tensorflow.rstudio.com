...
addition to some commonly used packages like "scipy", "pandas", and
"tensorflow-datasets".
...
| virtualenv | Install into a Python virtual environment                             |
| conda      | Install into an Anaconda Python environment                           |
...
The default tensorflow package is GPU capable on macOS and Linux.
However, if you will not be using a GPU, you can install the smaller
cpu-only package like this:
