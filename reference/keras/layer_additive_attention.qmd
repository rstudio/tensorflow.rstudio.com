...
| <button class="button"> ![](/reference/assets/GitHub-Mark-32px.png){width="20"} [View source on GitHub](https://github.com/rstudio/keras//blob/main/R/layer-attention.R#L166) </button> |
|:------------------------------:|:--------------------------------------:|
...
- [https://www.tensorflow.org/api_docs/python/tf/keras/layers/AdditiveAttention](https://www.tensorflow.org/api_docs/python/tf/keras/layers/AdditiveAttention)

- [https://keras.io/api/layers/attention_layers/additive_attention/](https://keras.io/api/layers/attention_layers/additive_attention/)
