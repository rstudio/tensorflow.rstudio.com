...
| <button class="button"> ![](/reference/assets/GitHub-Mark-32px.png){width="20"} [View source on GitHub](https://github.com/rstudio/keras//blob/main/R/layers-preprocessing.R#L510) </button> |
|:------------------------------:|:--------------------------------------:|
...
Adjusts the height of a batch of images by a random factor. The input should be a 3D (unbatched) or 4D (batched) tensor in the `"channels_last"`
...
- [https://www.tensorflow.org/api_docs/python/tf/keras/layers/RandomHeight](https://www.tensorflow.org/api_docs/python/tf/keras/layers/RandomHeight)
