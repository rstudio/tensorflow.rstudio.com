...
[R/layers-recurrent.R](https://github.com/rstudio/keras//blob/main/R/layers-recurrent.R#L249) 
...
- [https://www.tensorflow.org/guide/keras/rnn](https://www.tensorflow.org/guide/keras/rnn) 
  ...
  Other recurrent layers:  `layer_cudnn_gru()`, `layer_cudnn_lstm()`, `layer_gru()`, `layer_rnn()`, `layer_simple_rnn()`  Other recurrent layers:  `layer_cudnn_gru()`, `layer_cudnn_lstm()`, `layer_gru()`, `layer_rnn()`, `layer_simple_rnn()` 
