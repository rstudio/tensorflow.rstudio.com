...
[R/layers-recurrent-cells.R](https://github.com/rstudio/keras//blob/main/R/layers-recurrent-cells.R#L415) 
...
## Details
 ...
 See [the Keras RNN API guide](https://www.tensorflow.org/guide/keras/rnn) for details about the usage of RNN API.  This class processes one step within the whole time sequence input, whereas `tf$keras$layer$LSTM` processes the whole sequence.  For example:  ```
