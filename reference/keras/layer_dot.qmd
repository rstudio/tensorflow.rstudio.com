...
| <button class="button"> ![](/reference/assets/GitHub-Mark-32px.png){width="20"} [View source on GitHub](https://github.com/rstudio/keras//blob/main/R/layers-merge.R#L260) </button> |
|:------------------------------:|:--------------------------------------:|
...
- [https://www.tensorflow.org/api_docs/python/tf/keras/layers/dot](https://www.tensorflow.org/api_docs/python/tf/keras/layers/dot)

- [https://keras.io/api/layers/merging_layers/dot/](https://keras.io/api/layers/merging_layers/dot/)
