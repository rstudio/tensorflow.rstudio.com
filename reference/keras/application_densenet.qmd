...
| input_shape | optional shape list, only to be specified if `include_top`<br>is FALSE (otherwise the input shape has to be `(224, 224, 3)`<br>(with `channels_last` data format) or `(3, 224, 224)` (with `channels_first` data format). It should have exactly 3 inputs channels. |
