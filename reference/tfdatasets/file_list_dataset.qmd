...
[R/file_list_dataset.R](https://github.com/rstudio/tfdatasets//blob/main/R/file_list_dataset.R#L25) 
...
## Details
 For example, if we had the following files on our filesystem: - /path/to/dir/a.txt - /path/to/dir/b.csv - /path/to/dir/c.csv  If we pass "/path/to/dir/*.csv" as the `file_pattern`, the dataset would produce: - /path/to/dir/b.csv - /path/to/dir/c.csv 
