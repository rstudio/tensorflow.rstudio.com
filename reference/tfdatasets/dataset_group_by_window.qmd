...
| <button class="button"> ![](/reference/assets/GitHub-Mark-32px.png){width="20"} [View source on GitHub](https://github.com/rstudio/tfdatasets//blob/main/R/dataset_methods.R#L1456) </button> |
|:------------------------------:|:--------------------------------------:|
...
## See Also
- [https://www.tensorflow.org/api_docs/python/tf/data/Dataset#group_by_window](https://www.tensorflow.org/api_docs/python/tf/data/Dataset#group_by_window)
