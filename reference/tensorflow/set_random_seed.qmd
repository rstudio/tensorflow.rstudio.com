...
[R/seed.R](https://github.com/rstudio/tensorflow//blob/main/R/seed.R#L156) 
...
## Details
 ...
 This function should be used instead of `use_session_with_seed()` if you are using TensorFlow >= 2.0, as the concept of `session` doesn't really make sense anymore.  This functions sets:  
