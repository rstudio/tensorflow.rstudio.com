...
The cloudml package provides an R interface to https://cloud.google.com/ml-engine/Google Cloud Machine Learning Engine, a managed service that
enables:


*  Scalable training of models built with the
https://keras.rstudio.com/keras,
https://tensorflow.rstudio.com/tfestimatorstfestimators, and
https://tensorflow.rstudio.com/tensorflow R packages.

*  On-demand access to training on GPUs, including the new http://www.nvidia.com/object/tesla-p100.htmlTesla P100 GPUs from NVIDIA®.
