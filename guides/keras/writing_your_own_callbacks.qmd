...
description: > 
  Guide to writing new Keras callbacks for customizing the behavior during model
...
The `logs` dict contains the loss value, and all the metrics at the end
of a batch or epoch. Example includes the loss and mean absolute error.
