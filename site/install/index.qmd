...
`install_tensorflow` is a wrapper around `reticulate::py_install`. Please refer to ['Installing Python Packages'](https://rstudio.github.io/reticulate/articles/python_packages.html) for more information.
